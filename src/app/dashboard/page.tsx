...
export const metadata = {
  title: 'Mi Hogar | Stewardship Steel',
  description: 'Sigue el progreso de tu obra en tiempo real',
};
    ...
    <div className="min-h-screen bg-background pt-32 pb-24 font-sans">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-20 text-center md:text-left">
          <h1 className="font-heading text-4xl md:text-6xl text-primary font-bold tracking-tight mb-4 animate-fade-in">
            Tu próximo capítulo <br className="hidden md:block"/> se está construyendo
          </h1>
          <p className="text-foreground/70 text-lg md:text-xl font-light tracking-wide max-w-2xl opacity-0 animate-fade-in" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
